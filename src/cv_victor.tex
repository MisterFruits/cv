...
\cventry{2013 -- Aujourd'hui}
    ...
    {Toulouse (31)}{}
    {
        ...
        \begin{itemize}
            \item Génération de procedure opérationnelles
            \item Noyau d'optimisation en C++
            \item Implementation d'un protocol de télémétrie
        \end{itemize}
    }
\cventry{2013}
    ...
    {Toulouse (31)}{}
    {
        ...
        \begin{itemize}
            ...
            \item Developpement d'outils de visualisation avec JFreeChart et World Wind Java.
        \end{itemize}
        \textit{Utilisation  de GIT, Java, Eclipse, TPTP et VBA.} Stage ingénieur, 6 mois.}
% \cventry{2011 -- 2012}
...
\cventry{2010}
    ...
    {Toulouse (31)}{}
    {Tri et enrichissement de la base de données de photos du Conseil Général. 1 mois.}
