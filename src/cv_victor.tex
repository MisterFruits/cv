...
\extrainfo{Titulaire du permis B, 27 ans}
...
\cventry{Depuis 2015}
    ...
    {2 an}
    {
        Encadrement d'un groupe de travail européen pour l'évaluations de performances sur bancs d'essais (Xeon Phi, GPU, CPU). Support, maintenance, modernisation sur les machines du CINES.
...
% Aide au portage et à l'optimisation de code pour des SME (PRACE SHAPE)
    }
\cventry{2013 -- 2015}
    ...
    {2 an}
    {
        Développement et production d'un logiciel de \textbf{reconfiguration de la charge utile} d'un satellite de télécomunication.
        \begin{itemize}
...
\cventry{2011}
    ...
    {3 mois}
    {
        ...
        \begin{itemize}
            \item Caractérisation de signaux électriques.
