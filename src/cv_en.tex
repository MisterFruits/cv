...
\address{3 rue Tour Gayraud}{34070 Montpellier}
\mobile{+33 06 74 08 96 90}
...
\cventry{2015 - 2018}
    ...
    {
        \begin{itemize}
            \item Conception of a pipeline for installing software on a higth performance computer using the \textbf{package manager EasyBuild}.
