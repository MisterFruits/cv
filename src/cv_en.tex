...
\cventry{2021}
    ...
    {4 months}
    {
        \begin{itemize}
            ...
            \item Defined and traked key performance indicator of an HPC system with \textbf{Python}.
            \item Code optimisation with the european Hight Level Support Team.
        \end{itemize}
    }
...
\cventry{2013 -- 2015}
    ...
    {2 years}
    {
        \textbf{Development and industrialisation} of a telecommunication satellite payload configuration software.
        % Generation of operational procedure and integration on control center.
         % \textbf{Java and C++}.
        \begin{itemize}
            \item \textbf{C++} optimisation kernel.
...
\cventry{2013}
    ...
    {6 months}
    {
        ...
        \begin{itemize}
            ...
            \item \textbf{Conception and developement} of a simulated annealing solver
...
\cvlanguage{English}{Professional proficiency (TOEIC 935/990).}
    {French}{Native.}
\cvlanguage{Potuguese}{Proficient.}
...
\cvline{}{\begin{itemize}
    ...
    \item Organising workshop about male contraception
