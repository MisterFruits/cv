...
\title{Ingénieur HPC, mathématiques appliquées et developpement logiciel.}
...
\cventry{2013 -- 2015}
    ...
    {2 ans}
    {
        Développement et production d'un logiciel de \textbf{reconfiguration de la charge utile} d'un satellite de télécomunication. Génération de procédures opérationnelles et intégration sur \textbf{centre de contrôle}. \textbf{JAVA et C++}.
        % \begin{itemize}
...
\cventry{2013}
    ...
    {6 mois}
    {
        Optimisation de \textbf{l'allocation fréquentielle} d'un \textbf{satellite multi-beam}.
         Retro-engineering et amélioration d'un noyau codé en programmation par contraintes.
         \textbf{Conception et réalisation d'un solveur} recuit simulé.
        % \begin{itemize}
