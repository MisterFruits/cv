...
Passionné par l’algorithmie et l’optimisation, j'ai d'abord effectué un stage ingénieur chez Airbus Defense and Space pour y travailler ensuite en assistance technique (sous-traitance).
Cela m’a permis de découvrir un environnement multi-disciplinaire très riche et complexe, pour lequel tant de chose reste à accomplir.
de rencontrer des équipes compétentes et motivées,
