...
Passionné par l’algorithmie et l’optimisation, j'ai découvert le monde du spacial lors de mon stage ingénieur chez Airbus Defense and Space avec qui je travaille depuis presque un an.
Cela m’a permis de découvrir un environnement multi-disciplinaire très riche, auquel j'ai envie d'apporter ma contribution.
