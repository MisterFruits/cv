...
Il me semble que ces axes sont aujourd'hui stratégiques pour Airbus Defence and
Space et la réutilisation de mes compétences dans ce domaine vous serait
...
% afin de
Cette expérience peut être valorisante dans le cadre des problèmatiques
des tests de matériel à l'AIT.
}
