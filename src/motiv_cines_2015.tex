...
J'ai aussi pu, durant ma formation, réaliser un stage à l'Université Fédérale d'Uberlandia au Brésil. Mon role était alors de d'effectuer une comparaison de deux réseaux de neuronnes artificiels utilisés pour la simulation de prothèse en réalité augmenté. J'ai établit -- plan de test -- rapport technique destiné à la publication.
