...
% Intro
{
Votre annonce pour un poste d'ingénieur de recherche,
support HPC et projet européen -- reférencée DCIIGRSUPPRA,
a retenue toute mon attention.
Diplômé de l'INSA (Institut National des Science Appliquées) en
mathématiques appliquées et informatique scientifique, je m'intéresse
...
Dans le domaine des outils de calculs destinés à la recherche, j'ai eu
l'opportunité de travailler à l'université d'Uberlandia au Brésil dans le
cadre d'un stage de formation de 3 mois.
Mon rôle était alors de comparer de deux réseaux de neurones
...
prêt à partager de mon dynamisme et mes connaissances.
}
...
J'espère vous avoir communiqué mon enthousiasme et je souhaiterais vous
rencontrer pour un entretien.
}
