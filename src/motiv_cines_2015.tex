...
\end{document}
evoluer dans un milieu de recherche o
%%%%%%%%%%%%%%%%%%%%u mes compétence en math info pourront mieux s'exprimer que dans milieu industriel
plus de competence en gras dans lc
%% NOTES          %%
%%%%%%%%%%%%%%%%%%%%
